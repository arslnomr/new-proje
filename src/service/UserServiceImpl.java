...
public class UserServiceImpl extends AbstractService implements UserService{
    ...
    @Override
    public User addUser() {// Yeni Musteri olusturalim...Musteri bilgilerini Scanner Class ile kullanicidan alalim...
        ...
        User currentUser = new User(addUser().getId(), firstName, lastName, userName, password, new Address(address, City.values()[chosenCity], zipCode));
